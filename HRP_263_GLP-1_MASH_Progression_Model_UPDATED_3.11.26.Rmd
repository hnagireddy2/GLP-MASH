...
cat("\n========== ESSENCE Calibration: Fibrosis Regression ==========\n")
...
# Cumulative: 1 minus those still in fibrosis states (never reached severe)
fibrosis_states <- c("F0", "F1", "F2", "F3", "F4_CC")
pct_severe <- 1 - rowSums(m_tr[, fibrosis_states])
